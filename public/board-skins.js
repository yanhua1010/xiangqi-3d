...
(() => {
  ...
  const THEMES = [
    ...
    },
    {
      id: "celadon",
      name: "月白 · 青瓷",
      top: "#dbe9e1", bottom: "#a8c9c0", grain: "rgba(255,255,255,.20)", grainDark: "rgba(39,73,68,.10)",
      frame: "#536c64", outer: "#8cae9f", inner: "#c2d8cb", rim: "#c99a56", line: "#50756e", river: "#f6e7c4",
      fog: "#dce8df", ground: "#9cb4a5", sun: "#d59a7e", lantern: "#f2bb67", rough: .62, metal: .08,
      hemi: "#f8fff8", hemiGround: "#8da79a", key: "#fff0c4", keyPower: 2.35,
    },
    {
      id: "begonia",
      name: "海棠 · 春色",
      top: "#e9c9bd", bottom: "#c98c87", grain: "rgba(255,255,255,.18)", grainDark: "rgba(91,38,42,.10)",
      frame: "#613b3a", outer: "#b17669", inner: "#dfaa9a", rim: "#d8ad61", line: "#704544", river: "#f8e6c5",
      fog: "#ebd8cf", ground: "#ae837a", sun: "#cf7469", lantern: "#ffc275", rough: .58, metal: .08,
      hemi: "#fff5ee", hemiGround: "#ac8e85", key: "#ffe8c8", keyPower: 2.3,
    },
    {
      id: "yunjin",
      name: "云锦 · 金彩",
      top: "#ead5a7", bottom: "#c9a060", grain: "rgba(255,246,211,.18)", grainDark: "rgba(91,51,28,.12)",
      frame: "#5a3029", outer: "#a9673d", inner: "#d19a58", rim: "#f1ca6a", line: "#754735", river: "#fff0c9",
      fog: "#e5d6bd", ground: "#ad865e", sun: "#d67c55", lantern: "#ffd06e", rough: .5, metal: .16,
      hemi: "#fff6dc", hemiGround: "#a98a5c", key: "#ffe5ae", keyPower: 2.45,
    },
    {
      id: "bamboo",
      name: "竹影 · 清韵",
      top: "#cdddbb", bottom: "#91ad89", grain: "rgba(255,255,235,.14)", grainDark: "rgba(37,71,45,.12)",
      frame: "#385345", outer: "#68866e", inner: "#aac39f", rim: "#d1aa5e", line: "#4e6c55", river: "#f6edcf",
      fog: "#dce6d1", ground: "#849b85", sun: "#cf9974", lantern: "#f4bf70", rough: .58, metal: .08,
      hemi: "#f2fae6", hemiGround: "#849d87", key: "#ffedbf", keyPower: 2.25,
    },
    {
      id: "cloisonne",
      name: "景泰蓝 · 瑞彩",
      top: "#b9e0d8", bottom: "#619fa3", grain: "rgba(255,255,255,.18)", grainDark: "rgba(16,70,73,.16)",
      frame: "#164653", outer: "#326a73", inner: "#8fc4bb", rim: "#e1bd62", line: "#20546a", river: "#f7e9bd",
      fog: "#cfe4dd", ground: "#6f9995", sun: "#bc7664", lantern: "#ffcf72", rough: .42, metal: .2,
      hemi: "#eafff6", hemiGround: "#5f8c89", key: "#ffe8a7", keyPower: 2.55,
    },
  ];

  const state = {
    active: localStorage.getItem("xiangqi-board-skin") || "celadon",
    options: null,
    lastGame: null,
    lastMap: null,
  };
